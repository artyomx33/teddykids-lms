-- ============================================
-- 🧸📚 RESTORE TEDDY KIDS KNOWLEDGE CENTER
-- ============================================
-- This file restores ALL Knowledge Center content
-- 
-- Modules Included:
-- 1. Intern Working Hours & Substitute Contracts  
-- 2. Working in BSO at Lorentzkade
-- 3. Safety & Health at Lorentzkade
-- 4. Introduction to TISA
-- 5. Child Development Milestones
-- 6. Activity Planning & Documentation
-- ============================================
...
DO $$ BEGIN
  ...
  RAISE NOTICE '✅ All modules and sections imported';
  RAISE NOTICE '✅ Tables created: tk_documents, tk_document_sections, staff_knowledge_completion';
