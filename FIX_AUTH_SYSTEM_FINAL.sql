...
-- 3. Add identity record for email auth (with provider_id)
INSERT INTO auth.identities (
  ...
  'ee6427c2-39eb-4129-a090-1a3cca81af4e',
  'ee6427c2-39eb-4129-a090-1a3cca81af4e'::UUID,
...
SELECT
  'IDENTITY VERIFICATION' as test_name,
  provider_id,
  user_id,
  provider,
  CASE
    WHEN provider = 'email' THEN '✅ EMAIL IDENTITY CREATED'
    ELSE '❌ Identity issue'
...
DO $$ BEGIN
  ...
  RAISE NOTICE '✅ Identity created with provider_id';
