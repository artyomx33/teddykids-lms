-- ============================================
-- 🧸📚 COMPLETE KNOWLEDGE CENTER RESTORE
-- ============================================

-- Step 1: Drop existing tables if they exist (clean slate)
DROP TABLE IF EXISTS public.staff_knowledge_completion CASCADE;
DROP TABLE IF EXISTS public.tk_document_sections CASCADE;
DROP TABLE IF EXISTS public.tk_documents CASCADE;
...
-- Success message
SELECT '✅ Knowledge Center Restored! ' || COUNT(*) || ' modules loaded' as status
FROM tk_documents;
