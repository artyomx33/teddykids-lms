-- ============================================
-- 🧸📚 CLEAR AND RESTORE KNOWLEDGE CENTER
-- ============================================

-- Step 1: Clear existing data
TRUNCATE TABLE public.staff_knowledge_completion CASCADE;
TRUNCATE TABLE public.tk_document_sections CASCADE;
TRUNCATE TABLE public.tk_documents CASCADE;

-- Step 2: Now insert all fresh data
...
-- Success!
SELECT '✅ Knowledge Center Restored! Refresh /growbuddy/knowledge' as status;
